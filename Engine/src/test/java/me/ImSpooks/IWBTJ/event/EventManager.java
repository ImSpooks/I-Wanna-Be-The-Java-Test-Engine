...
public class EventManager {
	...
	public void register(Listener o, Class<? extends Event> clazz) {
		for (Method method : o.getClass().getDeclaredMethods()) {
	...
	private void register(Method method, Listener o) {
		Class<?> clazz = method.getParameterTypes()[0];
		EventTarget annotation = method.getAnnotation(EventTarget.class);
		final Data methodData = new Data(o, method, annotation.priority().getSlot(), annotation.ignoreCancelled());
