...
public class DSPStream implements Stream {
	...
	public DSPStream(BufferedInputStream inputStream)
	...
	private void validateChannel(DSPStream ch) throws FileFormatException {
	...
	private byte[] doDecode() throws IOException {
		...
		filepos += inputStream.read(rawdata);
