package org.hackyourlife.gcn.dsp.file;
...
public class DSPFile implements Stream {
	...
	private long	ca;
	private int[]	coef; /* really 8x2 */
	private int	gain;
	private int	initial_ps;
	private int	initial_hist1;
	private int	initial_hist2;
	private int	loop_ps;
	private int	loop_hist1;
	private int	loop_hist2;
	...
	public DSPFile(RandomAccessFile file)
	...
	public DSPFile(RandomAccessFile ch1, RandomAccessFile ch2)
			throws FileFormatException, IOException {
		this(ch1);
		this.ch2 = new DSPFile(ch2);
	...
	private void validateChannel(DSPFile ch) throws FileFormatException {
