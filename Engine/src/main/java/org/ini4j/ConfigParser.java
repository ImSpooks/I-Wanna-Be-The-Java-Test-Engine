...
public class ConfigParser implements Serializable
{
    ...
    static class PyIni extends Ini
    {
        ...
        protected String fetch(Section section, String optionName, Map<String, String> variables)
        ...
        protected void resolve(StringBuilder buffer, Section owner, Map<String, String> vars) throws InterpolationMissingOptionException
        {
